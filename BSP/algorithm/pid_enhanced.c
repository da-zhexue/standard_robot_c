 ...
 ******************************************************************************
 */
#include "algorithm/pid_enhanced.h"

/******************************** FUZZY PID **********************************/
static float FuzzyRuleKpRAW[7][7] = {
    {PB, PB, PM, PM, PS, ZE, ZE},   // 第0行
    {PB, PB, PM, PS, PS, ZE, PS},   // 第1行
    {PM, PM, PM, PS, ZE, PS, PS},   // 第2行
    {PM, PM, PS, ZE, PS, PM, PM},   // 第3行
    {PS, PS, ZE, PS, PS, PM, PM},   // 第4行
    {PS, ZE, PS, PM, PM, PM, PB},   // 第5行
    {ZE, ZE, PM, PM, PM, PB, PB}    // 第6行
};
...
float Feedforward_Calculate(Feedforward_t *ffc, float ref)
{
    ...
    float_constrain(&ffc->Output, -ffc->MaxOut, ffc->MaxOut);
