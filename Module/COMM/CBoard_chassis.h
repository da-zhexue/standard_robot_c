...
void CBoard_Referee_Tranmit(const cboard_chassis_t* cbord_chassis_ptr, uint8_t game_start, uint8_t camp, uint8_t attitude, uint16_t shoot_heat, uint16_t bullet_allow);
